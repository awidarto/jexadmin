<a class="btn btn-transparent btn-info btn-sm" id="confirm_data"><i class="fa fa-calendar"></i> Confirm Data</a>
...
<div id="confirm-data-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary" id="do-confirm-data">Confirm</button>
    </div>
</div>
