...
class HolidayController extends AdminController {
    ...
    public function postIndex()
    {
        ...
        $this->fields = array(
            array('holidayDate',array('kind'=>'datetime','query'=>'like','pos'=>'both','show'=>true)),
            array('holidayDescription',array('kind'=>'text','query'=>'like','pos'=>'both','show'=>true)),
    ...
    public function makeActions($data)
    {
        ...
        $edit = '<a href="'.URL::to('holiday/edit/'.$data['_id']).'"><i class="fa fa-edit"></i>Update</a>';
